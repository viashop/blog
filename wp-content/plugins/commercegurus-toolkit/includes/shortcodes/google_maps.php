...
function cg_map_sc($atts, $content=null, $code) {
	...
	$cgtk_settings = cgtk_get_settings();
	if ( $cgtk_settings ) {
		$cg_gmaps_key = $cgtk_settings['gmaps_key'];
	}
	?> 

    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=<?php echo $cg_gmaps_key; ?>"></script>
