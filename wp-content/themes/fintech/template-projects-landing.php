...
$fintechcommercegurus_portfolio_columns = '';
$fintechcommercegurus_portfolio_columns  = fintechcommercegurus_getoption( 'fintechcommercegurus_portfolio_columns' );
...
<div class="container">
    <div class="row">
        ...
        <ul id="filters">
            <li><a href="#" data-filter="*" class="selected is-checked"><?php esc_html_e( 'All', 'fintech' ); ?></a></li>
            <?php 
        ...
        <?php if ( $fintechcommercegurus_portfolio_columns == 'two' ) { ?>
            <div id="project" class="project-two-cols">

        <?php } else if ( $fintechcommercegurus_portfolio_columns == 'three' ) { ?>
            <div id="project" class="project-three-cols">

        <?php } else if ( $fintechcommercegurus_portfolio_columns == 'four' ) { ?>
...
<script src="<?php bloginfo('template_directory');?>/js/src/cond/isotope.pkgd.min.js"></script>
