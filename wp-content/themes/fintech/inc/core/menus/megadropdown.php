...
class fintechcommercegurus_primary_menu extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strpos( $class_names, 'text' ) !== false ) {
...
// **********************************************************************// 
// Allow HTML within the Description Field
// **********************************************************************// 
...
add_filter( 'wp_nav_menu_objects', 'fintechcommercegurus_add_menu_parent_class' );

function fintechcommercegurus_add_menu_parent_class( $items ) {
...
class fintechcommercegurus_mobile_menu extends Walker_Nav_Menu {
